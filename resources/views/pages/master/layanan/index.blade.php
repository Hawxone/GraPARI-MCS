        ...
        <div class="card" style="margin-top:20px">
            ...
            <div class="card-body">
                <div class="button-group" style="margin-bottom: 20px">
                    <button class="btn btn-light" id="tambah" data-toggle="modal" data-target="#myModal">Tambah Layanan</button>
                </div>
                ...
                <table id="layanan" class="table table-bordered table-striped">
                    ...
                    @foreach($layanan as $p)
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-light edit-modal" data-id="{{$p->layanan_id}}" data-toggle="modal" data-target="#myModal"><i class="fas fa-edit"></i></button>
                                <button class="btn btn-light delete-modal" data-id="{{$p->layanan_id}}" data-title="{{ $p->nama_layanan }}" ><i class="fas fa-trash-alt"></i></button>
                            </td>
                        </tr>
                        <?php $no++; ?>
                    @endforeach
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="frmProducts" name="frmProducts" class="form-horizontal" method="post" action="{{ route('layanan.store') }}">
                        <span id="err"></span>
                        {{ csrf_field() }}
        ...
        <script>
            $(document).on('click','.edit-modal', function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        console.log(data);
                        $('#idform').val(data.layanan_id);
                        $('#idact').val("edit");
                        $('#fnama').val(data.nama_layanan);
                    }
                })
            })
        </script>
